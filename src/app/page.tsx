...
export default function Home() {
  ...
  return (
    <main className="h-screen relative overflow-hidden">
      ...
      <Link
        href="/admin"
        className="absolute top-4 right-4 z-20 bg-white hover:bg-gray-50 text-gray-700 font-semibold px-4 py-2 rounded-lg shadow-lg transition-all duration-200 flex items-center gap-2"
      >
